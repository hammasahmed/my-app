        ...
        <div className="flex items-center gap-4 shrink-0">
          ...
          >
            <span className="[&>svg]:h-6 [&>svg]:w-6 [&>svg]:fill-black">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <path d="M448,209.9a210.1,210.1,0,0,1-122.8-39.3v178.7A162.6,162.6,0,1,1,185,188.3v89.2a74.6,74.6,0,1,0,52.2,71.2V0h88a121.2,121.2,0,0,0,1.9,22.2h0A122.2,122.2,0,0,0,381,93.1a121.4,121.4,0,0,0,67,20.1Z" />
              </svg>
            </span>
          </a>
          <a
